sim_betas_lavaan <- function(dat, theories){
  ...
  if(theories == "M&E"){
    ...
    ME1.Mot.Imi <- parameterestimates(ME.mod)$est[parameterestimates(ME.mod)$label == "b1"] 
    ME2.Soc.Imi <- parameterestimates(ME.mod)$est[parameterestimates(ME.mod)$label == "b2"]
    
    ME3.Mot.Soc <- parameterestimates(ME.mod)$est[parameterestimates(ME.mod)$label == "phi"]
    ...
    RP1.Imi.AS.11 <- parameterestimates(RP.mod.11)$est[parameterestimates(RP.mod.11)$label == "b1"]
    RP2.Imi.Sym.11 <- parameterestimates(RP.mod.11)$est[parameterestimates(RP.mod.11)$label == "b2"]
    
    RP3.AS.Soc.11 <- parameterestimates(RP.mod.11)$est[parameterestimates(RP.mod.11)$label == "b3"]
    RP4.Imi.Soc.11 <- parameterestimates(RP.mod.11)$est[parameterestimates(RP.mod.11)$label == "b4"]
    
    RP5.Sym.Soc.11 <- parameterestimates(RP.mod.11)$est[8]
    ...
    RP1.Imi.AS.12 <- parameterestimates(RP.mod.12)$est[parameterestimates(RP.mod.12)$label == "b1"]
    RP2.Imi.Sym.12 <- parameterestimates(RP.mod.12)$est[parameterestimates(RP.mod.12)$label == "b2"]
    
    RP3.AS.Soc.12 <- parameterestimates(RP.mod.12)$est[parameterestimates(RP.mod.12)$label == "b3"]
    RP4.Imi.Soc.12 <- parameterestimates(RP.mod.12)$est[parameterestimates(RP.mod.12)$label == "b4"]
    
    RP5.Sym.Soc.12 <- parameterestimates(RP.mod.12)$est[8]
    ...
    RP1.Imi.AS.21 <- parameterestimates(RP.mod.21)$est[parameterestimates(RP.mod.21)$label == "b1"]
    RP2.Imi.Sym.21 <- parameterestimates(RP.mod.21)$est[parameterestimates(RP.mod.21)$label == "b2"]
    
    RP3.AS.Soc.21 <- parameterestimates(RP.mod.21)$est[parameterestimates(RP.mod.21)$label == "b3"]
    RP4.Imi.Soc.21 <- parameterestimates(RP.mod.21)$est[parameterestimates(RP.mod.21)$label == "b4"]
    
    RP5.Sym.Soc.21 <- parameterestimates(RP.mod.21)$est[8]
    ...
    RP1.Imi.AS.22 <- parameterestimates(RP.mod.22)$est[parameterestimates(RP.mod.22)$label == "b1"]
    RP2.Imi.Sym.22 <- parameterestimates(RP.mod.22)$est[parameterestimates(RP.mod.22)$label == "b2"]
    
    RP3.AS.Soc.22 <- parameterestimates(RP.mod.22)$est[parameterestimates(RP.mod.22)$label == "b3"]
    RP4.Imi.Soc.22 <- parameterestimates(RP.mod.22)$est[parameterestimates(RP.mod.22)$label == "b4"]
    
    RP5.Sym.Soc.22 <- parameterestimates(RP.mod.22)$est[8]
    ...
    OR1.Perc.Imi.11 <- parameterestimates(OR.mod.11)$est[parameterestimates(OR.mod.11)$label == "b1"]
    OR2.Perc.Self.11 <- parameterestimates(OR.mod.11)$est[parameterestimates(OR.mod.11)$label == "b2"]
    
    OR3.Perc.RC.F1.11 <- parameterestimates(OR.mod.11)$est[parameterestimates(OR.mod.11)$label == "b7"]
    
    OR4.Perc.VL2.F1.11 <- parameterestimates(OR.mod.11)$est[parameterestimates(OR.mod.11)$label == "b8"]
    
    OR5.Imi.RC.F1.11 <- parameterestimates(OR.mod.11)$est[parameterestimates(OR.mod.11)$label == "b3"]
    
    OR6.Imi.VL2.F1.11 <- parameterestimates(OR.mod.11)$est[parameterestimates(OR.mod.11)$label == "b4"]
    
    OR7.Self.RC.F1.11 <- parameterestimates(OR.mod.11)$est[parameterestimates(OR.mod.11)$label == "b5"]
    
    OR8.Self.VL2.F1.11 <- parameterestimates(OR.mod.11)$est[parameterestimates(OR.mod.11)$label == "b6"]
    ...
    OR1.Perc.Imi.12 <- parameterestimates(OR.mod.12)$est[parameterestimates(OR.mod.12)$label == "b1"]
    OR2.Perc.Self.12 <- parameterestimates(OR.mod.12)$est[parameterestimates(OR.mod.12)$label == "b2"]
    
    OR3.Perc.RC.F1.12 <- parameterestimates(OR.mod.12)$est[parameterestimates(OR.mod.12)$label == "b7"]
    
    OR4.Perc.VL2.F1.12 <- parameterestimates(OR.mod.12)$est[parameterestimates(OR.mod.12)$label == "b8"]
    
    OR5.Imi.RC.F1.12 <- parameterestimates(OR.mod.12)$est[parameterestimates(OR.mod.12)$label == "b3"]
    
    OR6.Imi.VL2.F1.12 <- parameterestimates(OR.mod.12)$est[parameterestimates(OR.mod.12)$label == "b4"]
    
    OR7.Self.RC.F1.12 <- parameterestimates(OR.mod.12)$est[parameterestimates(OR.mod.12)$label == "b5"]
    
    OR8.Self.VL2.F1.12 <- parameterestimates(OR.mod.12)$est[parameterestimates(OR.mod.12)$label == "b6"]
    ...
    OR1.Perc.Imi.21 <- parameterestimates(OR.mod.21)$est[parameterestimates(OR.mod.21)$label == "b1"]
    OR2.Perc.Self.21 <- parameterestimates(OR.mod.21)$est[parameterestimates(OR.mod.21)$label == "b2"]
    
    OR3.Perc.RC.F1.21 <- parameterestimates(OR.mod.21)$est[parameterestimates(OR.mod.21)$label == "b7"]
    
    OR4.Perc.VL2.F1.21 <- parameterestimates(OR.mod.21)$est[parameterestimates(OR.mod.21)$label == "b8"]
    
    OR5.Imi.RC.F1.21 <- parameterestimates(OR.mod.21)$est[parameterestimates(OR.mod.21)$label == "b3"]
    
    OR6.Imi.VL2.F1.21 <- parameterestimates(OR.mod.21)$est[parameterestimates(OR.mod.21)$label == "b4"]
    
    OR7.Self.RC.F1.21 <- parameterestimates(OR.mod.21)$est[parameterestimates(OR.mod.21)$label == "b5"]
    
    OR8.Self.VL2.F1.21 <- parameterestimates(OR.mod.21)$est[parameterestimates(OR.mod.21)$label == "b6"]
    ...
    OR1.Perc.Imi.22 <- parameterestimates(OR.mod.22)$est[parameterestimates(OR.mod.22)$label == "b1"]
    OR2.Perc.Self.22 <- parameterestimates(OR.mod.22)$est[parameterestimates(OR.mod.22)$label == "b2"]
    
    OR3.Perc.RC.F1.22 <- parameterestimates(OR.mod.22)$est[parameterestimates(OR.mod.22)$label == "b7"]
    
    OR4.Perc.VL2.F1.22 <- parameterestimates(OR.mod.22)$est[parameterestimates(OR.mod.22)$label == "b8"]
    
    OR5.Imi.RC.F1.22 <- parameterestimates(OR.mod.22)$est[parameterestimates(OR.mod.22)$label == "b3"]
    
    OR6.Imi.VL2.F1.22 <- parameterestimates(OR.mod.22)$est[parameterestimates(OR.mod.22)$label == "b4"]
    
    OR7.Self.RC.F1.22 <- parameterestimates(OR.mod.22)$est[parameterestimates(OR.mod.22)$label == "b5"]
    
    OR8.Self.VL2.F1.22 <- parameterestimates(OR.mod.22)$est[parameterestimates(OR.mod.22)$label == "b6"]
